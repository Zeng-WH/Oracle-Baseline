...
def main():
    ...
    for s, t in zip(source_text, target_text):
        ...
        sent_text = greedy_selection(s_tokens, t_tokens, 3)
    ...
    with open('/home/ypd-19-2/prefix-tuning/QMSum-transfer/product_as_test/oracle/train.tgt', 'w') as w:
        for item in tgt_list:
            w.write(item)
            w.write('\n')

    with open('/home/ypd-19-2/prefix-tuning/QMSum-transfer/product_as_test/oracle/train.oracle', 'w') as w:
